...
Rails::Initializer.run do |config|
  config.gem 'activerecord-jdbc-adapter', :version => "0.9.7", :lib => 'jdbc_adapter'
  ...
  config.load_paths += %W( #{RAILS_ROOT}/app/jobs #{RAILS_ROOT}/app/mailers #{RAILS_ROOT}/app/tasks  )
  ...
  config.cache_store = :synchronized_memory_store
end
